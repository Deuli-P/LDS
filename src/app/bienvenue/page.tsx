...
export default function LandingPage() {
  ...
  return (
    ...
    <section className="w-full my-10 flex flex-col justify-center items-center">
      ...
      <Image src="/assets/images/avatar/avatar.jpg" width={200} height={0} alt="avatar LDS" className=" mt-10 mx-auto"/>
      <button
    ...
    <section className="w-full my-10 flex flex-col justify-center items-center bg-foreGround pb-10">
      ...
      <div className="w-10/12 flex justify-around mt-10">
        ...
        <Image src="/assets/images/avatar/avatar.jpg" width={200} height={0} alt="avatar LDS" className="w-[200px] mt-10"/>
    ...
    <section className="w-full my-10 flex flex-col justify-center items-center">
      ...
      <div className="w-10/12 flex flex-wrap justify-center mt-10">
        {/* <Image src="/assets/images/icons8-logo-nintendo-switch-90.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/>
        <Image src="/assets/images/icons8-airbnb-100.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/>
        <Image src="/assets/images/icons8-entouré-de-vapeur-100.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/>
        <Image src="/assets/images/icons8-logo-100.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/>
        <Image src="/assets/images/icons8-logo-mastercard-128.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/>
        <Image src="/assets/images/icons8-logo-amazon-alexa-100.png" width={60} height={0} alt="logo entreprise" className="mx-[2%] mt-10"/> */}
      </div>
    </section>
    ...
    <section className="w-full my-10 relative">
      <Image src="/assets/images/sav.jpg" width={0} height={0} alt="image du service client" className="w-full"/>
      <button
